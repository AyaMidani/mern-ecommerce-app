        ...
        <Card className="w-full max-w-sm mx-auto">
            <div onClick={()=>handleGetProductDetails(product?._id)}>
                <div className="relative">
                    ...
                    />
                    {
                        Number(product?.totalStock) === 0 ?<Badge className="absolute top-2 left-2 bg-red-500 hover:bg-red-600">Out of Stock</Badge> : product?.totalStock < 10 ? 
            ...
            <CardFooter>
                {
                    Number(product?.totalStock) === 0 ? <Button disabled className="w-full opacity-60 cursor-not-allowed">Out Of Stock</Button> 
