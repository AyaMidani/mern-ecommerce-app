...
export const getAllOrdersForAdmin= createAsyncThunk('order/getAllOrdersForAdmin',
  async()=>{
    const response= await axios.get(`http://localhost:5001/api/admin/orders/get/`);
...
export const getOrderDetailsForAdmin= createAsyncThunk('order/getOrderDetailsForAdmin',
  async(id)=>{
    const response= await axios.get(`http://localhost:5001/api/admin/orders/details/${id}`);
    return response?.data;
  }
)
...
export const UpdateOrderStatus= createAsyncThunk('order/UpdateOrderStatus',
  async({id,orderStatus})=>{
    const response= await axios.put(`http://localhost:5001/api/admin/orders/update/${id}`,{orderStatus});
    return response?.data;
  }
)
